import 'package:antovid/Services/notification_service.dart';
import 'package:antovid/models/notification_models.dart';
...
class NotificationStartPage extends StatefulWidget {
  @override
  _NotificationStartPageState createState() => _NotificationStartPageState();
}

class _NotificationStartPageState extends State<NotificationStartPage> {
  ...
  Future<void> _repeatNotification() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.periodicallyShow(0, 'Handwash Notifier',
        'Wash your Hands', RepeatInterval.EveryMinute, platformChannelSpecifics);
  }

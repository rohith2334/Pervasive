...
class ChartsSamplePage extends StatefulWidget {
  ChartsSamplePage({Key key, this.title, this.states}) : super(key: key);
  final List<String> states;

  final String title;

  @override
  _ChartsSamplePageState createState() => _ChartsSamplePageState();
}

class _ChartsSamplePageState extends State<ChartsSamplePage> {
